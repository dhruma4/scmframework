            ...
            if(empty($_POST["login_id"]))
            {
              ...
              elseif(!preg_match("/^[0-9A-Za-z]{8}$/", $_POST["login_id"]))
              {
                ...
                $resultenroll= $this->registration_model->get_enrollexists($enrollid);
                  ...
                  {
                  $is_valid=false;
                  $arrayerror['enroll']="Enrollment entered already exists.Please enter correct enrollment number";//echo "Enrollment entered already exists.Please enter correct enrollment number";
                  echo "";
                  }

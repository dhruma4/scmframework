				    ...
				    <form action="" method="POST">
				    	<table align="center">
				    		<tr>
		             		...
		             		<tr>
		             			<td colspan=5 align="left"><label><?php echo $i; echo "  "; echo $question['t_ques_text'] ?></label></td>
		             		</tr>
		             		<tr>
		             			<td colspan=5 align="left"><label><span class="error">* </span>Answer: </label></td>
		             		</tr>
		             		<tr>
		                	...
		                	<tr>
				   			...
				   			<tr>
				   				<td colspan=5 align="center"><input type="submit" value="Submit Test" id="submit_test"></td>
           					</tr>
           				</table>
		            </form>
		                 <?php } ?>
